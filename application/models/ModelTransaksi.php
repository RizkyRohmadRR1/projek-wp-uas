	...
	class ModelTransaksi extends CI_Model
	{
		...
		public function showdata()
		{
			return $this->db->query("
				SELECT id_transaksi,jml_qty,tgl_transaksi,total,(tb_pegawai.nama) AS pegawai,(tb_pelanggan.nama) AS pelanggan,(tb_paket.nama) AS paket
				FROM tb_transaksi 
				INNER JOIN tb_pegawai ON tb_transaksi.id_user=tb_pegawai.id_user
		...
		{
			return $this->db->query("
				SELECT id_transaksi,jml_qty,tgl_transaksi,total,(tb_pegawai.nama) AS pegawai,(tb_pelanggan.nama) AS pelanggan,(tb_paket.nama) AS paket,tb_pelanggan.id_pelanggan,harga
				FROM tb_transaksi 
				INNER JOIN tb_pegawai ON tb_transaksi.id_user=tb_pegawai.id_user
				INNER JOIN tb_pelanggan ON tb_transaksi.id_pelanggan=tb_pelanggan.id_pelanggan
				INNER JOIN tb_paket ON tb_transaksi.id_paket=tb_paket.id_paket
		...
		{
			$sql = $this->db->query("SELECT id_transaksi,(tb_pegawai.nama) as pegawai, (tb_pelanggan.nama) as pelanggan, (tb_paket.nama) as paket, tgl_transaksi,jml_qty,total
				FROM tb_transaksi
				INNER JOIN tb_pegawai ON tb_transaksi.id_user=tb_pegawai.id_user
				INNER JOIN tb_pelanggan ON tb_transaksi.id_pelanggan=tb_pelanggan.id_pelanggan
				INNER JOIN tb_paket ON tb_transaksi.id_paket=tb_paket.id_paket
